...
/**
 * PixelBlast WebGL background (from reactbits.dev/backgrounds/pixel-blast).
 * Adapted: the original `./PixelBlast.css` import is replaced with Tailwind
 * sizing on the container div.
 */
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      if (threeRef.current) {
        ...
        cancelAnimationFrame(t.raf as number);
      ...
      const t = threeRef.current as NonNullable<typeof threeRef.current>;
